...
Notes:
- Pages are split for mobile navigation: `index.html` (home), `story.html`, `girls.html`, `timeline.html`, `gallery.html`, `messages.html`.
...
- This site no longer uses a shared "family" password; private messages use owner-specific passwords.
- Owner-specific unlock passwords are set for messages:
  - Lanides (husband): `Eks_Lani`
  - Mercy (wife): `Mevrou__Uri-khos`
...
- `gallery.html` — photo gallery (now includes captions and a 10-image "Moments in Between" selection)
